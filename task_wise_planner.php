            ...
            <div class="container">
              ...
              <div class="container border border-secondary shadow-sm p-3 mb-5 bg-white rounded shift1_card" style="display:none;">
                ...
                <div class="col-sm col-md-6 col-lg-6 card card-primary card-outline">
                    <header><center>Process Batch Plan</center></header><hr>
                ...
                <div class="col-sm col-md-6 col-lg-6 card card-danger card-outline">
                    <header><center>Select Associates</center></header><hr>
                    <label for="">Start Time</label>
                ...
                <div id="process_gen_card" class="shift_assign_unassign">
                  ...
                  <div class="tab-pane" id="tabs-2" role="tabpanel">
                    <div class="row">
                      <div class="col-sm col-md-6 col-lg-6 card card-primary card-outline">
                        <header><center>Select Workstation</center></header><hr>
                            <label for="">Workstation</label>
                      ...
                      <div class="col-sm col-md-6 col-lg-6 card card-danger card-outline">
                        <header><center>Assign Process</center></header><hr>
                            <label for="">Process</label>
                  ...
                  <div class="tab-pane" id="tabs-3" role="tabpanel">
                    ...
                    <div class="row">
                      <div class="col-sm col-md-6 col-lg-6 card card-primary card-outline">
                          <header><center>Material Batch Plan</center></header><hr>
                  ...
                  <div class="tab-pane" id="tabs-4" role="tabpanel">
                    ...
                    <div class="row">
                      <div class="col-sm col-md-6 col-lg-6 card card-primary card-outline">
                          <header><center>Team Batch Plan</center></header><hr>
                  ...
                  <div class="tab-pane" id="tabs-5" role="tabpanel">
                    ...
                    <div class="row">
                      <div class="col-sm col-md-6 col-lg-6 card card-primary card-outline">
                          <header><center>Model Batch Plan</center></header><hr>
                          <label for="">Model: </label>
