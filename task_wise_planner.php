...
<div class="app-main__outer">
  ...
  <div class="app-main__inner">
    ...
    <div class="container">
      ...
      <div class="row text-center">
        <form method="post" class="col-4">
          ...
          <label for="">Production Target Date: </label>
          ...
          <div class="form-row form-inline" id="gen_shift_time">
            <div class="col">
              ...
              <button type="button" id="gen_shift_submit_new" name="button">Create Shift</button>
            ...
            <!-- [[ old submission for general shift - to be replaced ]] -->
          ...
          <div id="shift_time_form" style="display:none;">
            ...
            <div class="form-row">
              <div class="col">
                ...
                <!-- \\ -->
                <input type="number" id="s1noofassoc" value="0" min="0" step="1">
              </div>
            </div>
            <div class="form-row">
              <div class="col">
                ...
                <!-- \\ -->
                <input type="number" id="s2noofassoc" value="0" min="0" step="1">
              </div>
            </div>

            <!-- [[ button for multi shift submit - use this to change general shift code]] -->
      ...
      <hr>
      <div class="container border border-secondary shadow-sm p-3 mb-5 bg-white rounded shift1_card" style="display:none;">
    ...
    <div class="text-center"> <a href="task_wise_planner.php" class="btn btn-success">Close Planning For Day</a></div>
    ...
    <script>
      <?php $bdate = new DateTime(date('Y-m-d', strtotime($batchdate)));
      $formattedDate = $bdate->format('Y,(n-1),j,G,i,s,u'); ?>
      var startDateTime = new Date(<?php echo $formattedDate; ?>); // YYYY (M-1) D H m s ms (start time and date from DB)
...
<script>
  $(document).ready(function() {
    ...
    $('#material_user_count').on('change', function() {});
    $('#material_username').on('change', function() {
...
<script>
  $(document).ready(function() {
    ...
    $('#team_count').on('change', function() {});
    $('#team_username').on('change', function() {
